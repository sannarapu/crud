...
Ext.define('AM.view.${domainClass.getPropertyName()}.Add', {
    extend:'Ext.window.Window',
    alias:'widget.${domainClass.getPropertyName()}add',

    requires:['Ext.form.Panel'],

    title: messages.js.add.window.title('${domainClass.getNaturalName()}'),
    layout:'fit',
    autoShow:true,
    height:280,
    width:280,
