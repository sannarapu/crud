...
def generateForDomainClass(domainClass) {
    def templateGenerator = classLoader.loadClass("org.grails.plugins.extui.scaffolding.ExtGrailsTemplateGenerator").newInstance([classLoader] as Object[])
    templateGenerator.grailsApplication = grailsApp
    templateGenerator.pluginManager = pluginManager
    templateGenerator.extjscrudPluginDir = extjscrudPluginDir
    if (generateViews) {
        ...
        templateGenerator.generateExtController(domainClass,basedir)
        templateGenerator.generateExtModel(domainClass,basedir)
        templateGenerator.generateExtStore(domainClass,basedir)
        templateGenerator.generateExtAppView(domainClass,basedir)
        templateGenerator.generateExtViewport(domainClass,basedir)
    ...
    templateGenerator.generateMessageProperties(domainClass, basedir)
